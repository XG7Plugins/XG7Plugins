...
public class NPC1_7_1_16 extends NPC {
    ...
    public NPC1_7_1_16(Plugin plugin, String id, List<String> name, Location location) {
            ...
            try {
                ...
                if (playerSkin) {
                    if (XG7Plugins.getMinecraftVersion() > 7) {
                        ...
                        ((GameProfile) npcSkin).getProperties().putAll(playerGameProfile.getProperties());
                    } else {
                        net.minecraft.util.com.mojang.authlib.GameProfile playerGameProfile = NMSUtil.getCraftBukkitClass("entity.CraftPlayer").castToRObject(player).getMethod("getProfile").invoke();

                        npcSkin = new GameProfile(UUID.randomUUID(), (String) name);

                        ((net.minecraft.util.com.mojang.authlib.GameProfile) npcSkin).getProperties().putAll(playerGameProfile.getProperties());
                    }
                ...
                ReflectionObject packetPlayOutPlayerInfo = XG7Plugins.getMinecraftVersion() > 7 ?
                        NMSUtil.getNMSClass("PacketPlayOutPlayerInfo")
                ...
                ReflectionObject team;
                ReflectionObject packetPlayOutScoreboardTeam = null;

                if (XG7Plugins.getMinecraftVersion() > 8) {
                    team = NMSUtil.getNMSClass("ScoreboardTeam")
                    ...
                    packetPlayOutScoreboardTeam = NMSUtil.getNMSClass("PacketPlayOutScoreboardTeam")
                ...
                ReflectionObject packetPlayOutEntityLook = XG7Plugins.getMinecraftVersion() > 7 ?
                        NMSUtil.getNMSClass("PacketPlayOutEntity$PacketPlayOutEntityLook")
                        ...
                        :NMSUtil.getNMSClass("PacketPlayOutRelEntityMoveLook")
                ...
                if (XG7Plugins.getMinecraftVersion() > 8) playerNMS.sendPacket(packetPlayOutScoreboardTeam.getObject());
                ...
                ReflectionObject packetPlayOutPlayerInfo2 = XG7Plugins.getMinecraftVersion() > 7 ?NMSUtil.getNMSClass("PacketPlayOutPlayerInfo")
                        .getConstructor(NMSUtil.getNMSClass("PacketPlayOutPlayerInfo$EnumPlayerInfoAction").getAClass(),
                                Iterable.class)
