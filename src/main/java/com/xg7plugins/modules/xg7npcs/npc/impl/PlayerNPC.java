...
public class PlayerNPC extends NPC {
    ...
    public PlayerNPC(Plugin plugin, String id, Skin skin, Hologram hologram, Location spawnLocation, Map<EquipmentSlot, Item> equipments, boolean lookAtPlayer, Consumer<NPCClickEvent> npcClickEvent) {
        super(plugin, id, hologram, EntityTypes.PLAYER, spawnLocation, equipments, lookAtPlayer);
